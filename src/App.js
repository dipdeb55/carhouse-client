  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path='/addCar' element={<RequiredAuth><AddCars></AddCars></RequiredAuth>}></Route>
        <Route path='/blogs' element={<Blogs></Blogs>}></Route>
        <Route path='/cars/myitems' element={<RequiredAuth><MyItems></MyItems></RequiredAuth>}></Route>
